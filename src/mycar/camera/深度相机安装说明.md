...
- (6).修改参数
```
lsusb | egrep -i "2bc5|6366|0c45|orbbec"
lsusb -t
v4l2-ctl --list-devices
ls -l /dev/video*

查看对应设备的端口号,进入
src/mycar/camera/ros2_astra_camera/astra_camera/launch/astro_pro_plus.launch.xml
修改对应的端口号

Bus 001 Device 007: ID 2bc5:050f Orbbec 3D Technology International, Inc USB 2.0 Camera
Bus 001 Device 005: ID 2bc5:060f Orbbec 3D Technology International, Inc ORBBEC Depth Sensor
